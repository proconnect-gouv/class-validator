...
const IsDefined_1 = require("../decorator/common/IsDefined");
const IsOptional_1 = require("../decorator/common/IsOptional");
/**
    ...
    getTargetValidationMetadatas(targetConstructor, targetSchema, always, strictGroups, groups) {
        ...
        const uniqueInheritedMetadatas = inheritedMetadatas.filter(inheritedMetadata => {
            return !originalMetadatas.find(originalMetadata => {
                ...
                const isSameValidator = originalMetadata.name === inheritedMetadata.name ||
                    (originalMetadata.name === IsDefined_1.IS_DEFINED && inheritedMetadata.name === IsOptional_1.IS_OPTIONAL);
